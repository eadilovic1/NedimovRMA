...
class TestS2 {
    ...
    @Test
    suspend fun filterOutWordFromThirdNews(){
    ...
    @Test
    suspend fun detaljiVijestiNajblizeVijesti(){
    ...
    @Test
    suspend fun detaljiVijestiNajblizeVijestiBack(){
